...
var CleaningStatus = sequelize.define('cleaning_status', {
  cleaning_id: {
    type: DataTypes.INTEGER,
    primaryKey: true,
    autoIncrement: true
...
var Cleaner = sequelize.define('cleaner', {
  cleaner_post: {
    type: DataTypes.STRING,
    allowNull: false
  }
});
var Registrar = sequelize.define('registrar', {
  registrar_post: {
    type: DataTypes.STRING,
    allowNull: false
  }
...
var Booking = sequelize.define('booking', {
  ...
  booking_status: {
    type: DataTypes.ENUM('Ожидает подтвержения', 'Подтвержён', 'Отменён', 'Заселён', 'Выселен'),
